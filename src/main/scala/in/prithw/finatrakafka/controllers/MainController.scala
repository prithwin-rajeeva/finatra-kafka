package in.prithw.finatrakafka.controllers

import in.prithw.finatrakafka.models.http.GreetingsRequest
import javax.inject.{Inject, Singleton}
import com.jakehschwartz.finatra.swagger.SwaggerController
import io.swagger.models.Swagger
import in.prithw.finatrakafka.services.SampleMessageService
